...
var VENDOR_LIBS = [
  // Third party libs
  'babel-core/polyfill', 'bluebird', 'classnames', 'falcor', 'get-size', 'history', 'load-script', 'lodash', 'md5', 'moment', 
  'react', 'react-bootstrap', 'react-redux', 'react-router', 'redux', 'redux-actions', 'redux-devtools', 'redux-form', 'redux-logger', 
